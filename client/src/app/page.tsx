...
import { useAuth, useUser, SignInButton, SignedOut } from "@clerk/nextjs";
    ...
    const createUser = async () => {
      ...
      if (isSignedIn && user) {
        try {
          ...
          console.error(
            "An error occurred while creating the user in the backend:",
            error.message,
          );
        }
      }
    ...
    <div className="min-h-screen flex flex-col bg-white text-black">
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="mb-6">
            EDUMind is an intuitive platform designed for educators to create
            and manage course assignments and quizzes effortlessly. Leveraging
            AI, it allows professors to transform their lecture notes into
            dynamic assessments and organized course materials.
          </p>
          <p className="mb-6">
            The platform promotes structured course management by categorizing
            materials into modules, chapters, and assignments, displayed neatly
